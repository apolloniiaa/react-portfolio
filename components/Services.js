  ...
  return (
    <div name='services'>
      <section className='mb-64  md:mb-0  max-w-screen-lg mx-auto p-4'>
        <div>
          <h3 className='text-3xl py-1 text-primary  dark:text-textDark'>
            Services I offer{' '}
          </h3>
      ...
      <div name='experience' className=' w-full md:h-screen mt-20 '>
        <div className='max-w-screen-lg mx-auto p-4 flex flex-col justify-center w-full h-full md:h-auto  text-textLight'>
          <div>
            <p className='text-4xl font-bold border-b-4 dark:text-textDark dark:border-textDark border-gray-500 p-2 inline '>
              Experience
            </p>
          ...
          <div className='w-full grid grid-cols-2 sm:grid-cols-3 gap-8 text-center py-8  sm:px-0'>
            {techs.map(({ id, src, title, style }) => (
              <div
                key={id}
                className={`shadow-md hover:scale-105 duration-500 py-2 rounded-lg text-linksLight bg-portfolioCard`}
              >
